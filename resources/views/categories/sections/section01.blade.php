<div class="col-sm-8">
          ...
          <div class="col-sm-4">
            <div class="l-sidebar">
              @if($ads['box_1_sidebar_category']->active)
                <div class="adv">{!!$ads['box_1_sidebar_category']->content!!}</div>
                @endif
              @if($ads['box_2_sidebar_category']->active)
                <div class="adv">{!!$ads['box_2_sidebar_category']->content!!}</div>
                @endif
              <aside>
