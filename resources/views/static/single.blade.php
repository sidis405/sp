          ...
          <div class="col-sm-8">
            <div class="l-main">
              <div class="post post-single post-blue">
                <div class="post-meta">
                  <div class="category">Cronaca</div>
                  <div class="date">Pubblicato il 12.04.2016 alle 10.35</div>
                </div>
                <div class="clearfix"></div>
                <h1 class="single-title">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Non, maxime soluta officia reprehenderit.</h1>
                <p class="post-desc">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Earum, aliquam accusamus obcaecati repellendus nostrum ratione, animi quasi voluptates possimus voluptatem eaque, numquam modi omnis cumque laboriosam odit autem, dicta facilis!</p>
                <div class="post-meta">
