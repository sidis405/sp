          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="inner-intro">
                ...
                <h2>Accedi ora</h2>
                <div class="login-btns"><a href="#" class="btn btn-facebook btn-lg"><i class="fa fa-facebook fa-fw"></i> Accedi tramite Facebook</a><span class="or">oppure</span><a href="#" class="btn btn-primary btn-lg">Registrati</a></div>
              </div>
            </div>
            <div class="col-sm-3"></div>
          </div>
