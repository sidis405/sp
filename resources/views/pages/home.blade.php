          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="inner-intro">
                ...
                <h2>Accedi ora</h2>
                <div class="login-btns"><a href="/auth/facebook" class="btn btn-facebook btn-lg"><i class="fa fa-facebook fa-fw"></i> Accedi tramite Facebook</a><span class="or">oppure</span><a href="#" class="btn btn-primary btn-lg">Registrati</a></div>
              </div>
            </div>
            <div class="col-sm-3"></div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            ...
            <form>
              ...
              <div class="form-group">
                <input type="passowrd" placeholder="Conferma password" class="form-control">
              </div>
              <div class="row">
                <div class="col-sm-6">
                  <input type="checkbox">
                ...
                <div class="col-sm-6"><a href="#" class="btn btn-primary btn-lg btn-block">Continua</a></div>
              </div>
            </form>
          </div>
          <div class="col-sm-3"></div>
